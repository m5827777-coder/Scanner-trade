...
tgChat:  process.env.TG_CHAT_ID || '',
 ...
 tokens: [
    ...
    'MATIC','SHIB','LTC','UNI','ATOM','ETC','XLM','NEAR','BCH','APT',
    'ICP','OP','ARB','INJ','FIL','HBAR','VET','AAVE','GRT','MKR',
    'CRV','SNX','LDO','RUNE','FTM','SAND','AXS','RENDER','SUI','SEI',
    'TIA','PYTH','JTO','MANTA','ALT','PIXEL','PORTAL','DYM','STRK','WLD',
    'TON','NOT','PEPE','FLOKI','BONK','WIF','BOME','BRETT','NEIRO','POPCAT',
    'STX','CFX','KAVA','ONE','ZIL','WAVES','ICX','ONT','QTUM','ZEN',
    'BLUR','ENS','LRC','DYDX','PERP','OCEAN','BAND','REN','NMR','REQ',
    'ALGO','EGLD','THETA','FTT','CHZ','ENJ','MANA','GALA','IMX','AXS',
    'GMT','STEPN','MAGIC','LOOKS','X2Y2','NFT','RARE','SUPER','ALICE','TLM',
  ],
